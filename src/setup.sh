...
declare -r DOTFILES_TARBALL_URL="https://github.com/$GITHUB_REPOSITORY/archive/v2.tar.gz"
declare -r DOTFILES_UTILS_URL="https://raw.githubusercontent.com/$GITHUB_REPOSITORY/v2/src/utils.sh"

# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

declare dotfilesDirectory="$HOME/Code/dotfiles-v2"
...
verify_os() {
    ...
    if [ "$os_name" == "macos" ]; then
        ...
        if is_supported_version "$os_version" "$MINIMUM_MACOS_VERSION"; then
            ...
            printf "Sorry, this script is intended only for macOS %s or later" \
...
main() {
    ...
    # Check if this script was run directly (./<path>/setup.sh) and if not, it
